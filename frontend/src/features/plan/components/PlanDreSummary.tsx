  ...
  return (
    <Card className="overflow-hidden border-border/80 shadow-sm">
      ...
      <CardContent className="px-4 pb-2 pt-3 space-y-0">
        ...
        <DreLine label="(-) Quebras" value={brl(dre.quebras)} pctVal={pctOf(dre.quebras)} indent />
        <DreLine label="(-) Aging" value={brl(dre.aging)} pctVal={pctOf(dre.aging)} indent />
        ...
        <DreLine label="(-) Juros" value={brl(dre.juros)} pctVal={pctOf(dre.juros)} indent />
        <DreLine label="(-) Licenças" value={brl(dre.licencas)} pctVal={pctOf(dre.licencas)} indent />
